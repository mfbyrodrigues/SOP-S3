...
2. **⚙️ Gerenciamento de Processos**  
   - O que são processos e threads?  
   - Criação e execução de processos em Python (`os`, `multiprocessing`)  
   - Gerenciamento de processos com Pipes, Filas e Fila de Prioridade  
   - Sincronização de processos (uso de semáforos e mutex)
...
5. **📂 Gerenciamento de Arquivos**  
   ...
   - Simulação de sistemas de arquivos (`os`)  
   - Implementação de comandos básicos de terminal (`ls`, `cp`, `mv`, `rm`)
...
7. **⏱️ Escalonamento de Processos**  
...
9. **🌐 Sistemas Distribuídos e Redes**  
   - Comunicação entre processos e sistemas distribuídos (sockets)  
   - Simulação de servidores e clientes utilizando Python

10. **🛠️ Projeto Prático**  
    - Desenvolvimento de uma aplicação simples de sistema operacional utilizando os conceitos aprendidos  
